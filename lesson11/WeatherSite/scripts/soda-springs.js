...
async function getWeatherSumm() {
    const url = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&appid=840345b34fbe07325850273106defd71";
...
async function getFiveDay() {
    const url = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=840345b34fbe07325850273106defd71";
    const response = await fetch(url);
